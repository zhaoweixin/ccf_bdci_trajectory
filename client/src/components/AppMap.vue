...
<script>
    ...
    String.prototype.toCSVArray = function(){
        let data = [];
        ...
        methods: {
            ...
            * @district_draw() 绘制行政区域
            ...
            grid_draw(){
                ...
                /*----------------------------------------/
                 * Fun - all_data of geohash
                 * @load_all_order() 加载start_geohash/end_geohash数据
                 * @geohash_draw() 绘制start_geohash/end_geohash 块
                 * ////起点热点区域 | 终点热点区域////
                /-----------------------------------------*/
                load_all_order() {
                    this.$http.get('query',{
                ...
                load_day_order(){
                    this.$http.get('dataset/geohash/2017-05-01.csv').then((res) => {
                        let data = nest().key(d=>d.start_geo).entries(res.body.toCSVArray());
                        this.data_day = data;
                        //console.log(data);
